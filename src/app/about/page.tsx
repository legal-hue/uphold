...
export const metadata: Metadata = {
  title: "About Upheld | Legal Information for UK Employees, Tenants & Creators",
  description: "Upheld is a legal information tool helping UK employees, tenants, and creators understand their rights, navigate the process, and build their case. Not a law firm.",
  openGraph: {
    title: "About Upheld",
    description: "Legal information tool helping UK employees, tenants, and creators understand their rights.",
    url: "https://upheld.co.uk/about",
  },
};
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is Upheld a law firm?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Upheld is a legal information tool, not a law firm. We help you understand your rights, organise your case, and navigate the process, but we cannot give you personal legal advice or represent you. For advice specific to your situation, consult a qualified solicitor or barrister.",
      },
    },
    {
      "@type": "Question",
      "name": "Who built Upheld?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Upheld was built with legal expertise in employment, housing, and civil law. Every assessment and piece of guidance is based on current UK law.",
      },
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Your answers and case information are stored on your device only. We do not collect, store, or share them. There are no accounts and no sign-up required.",
      },
    },
    {
      "@type": "Question",
      "name": "Can I use Upheld if I am still employed?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upheld covers situations where you are still employed as well as those where you have already left. Many people use it while still in their job, particularly when raising a grievance.",
      },
    },
    {
      "@type": "Question",
      "name": "Are the deadline calculations accurate?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We calculate deadlines based on the standard rules for each type of claim. Individual circumstances, such as ACAS early conciliation, can extend them. Always verify your specific deadline with a legal professional.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What if my situation is complicated or unusual?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Upheld works best for the most common legal scenarios. If your situation does not fit neatly into the questions, we will tell you and point you towards specialist help such as ACAS, Citizens Advice, or a specialist solicitor.",
      },
    },
  ],
};
            ...
            {[
              {
                ...
                text: "Every assessment is based on current UK legislation and case law, not generic advice. The questions are designed by a qualified lawyer with expertise in these areas.",
              },
              {
                icon: Scale,
